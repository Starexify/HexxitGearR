...
public class SageHoodModel extends BaseHelmetModel {
    ...
    public static LayerDefinition createLayer() {
        ...
        PartDefinition helmet = partdefinition.addOrReplaceChild("helmet", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -9.0F, -6.0F, 10.0F, 9.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(0, 20).addBox(-4.0F, -4.0F, -5.5F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 24.0F, 1.0F));

        PartDefinition hood_back_2_r1 = helmet.addOrReplaceChild("hood_back_2_r1", CubeListBuilder.create().texOffs(45, 0).addBox(-2.5F, -10.5F, 4.75F, 5.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
