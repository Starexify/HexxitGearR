...
public interface HGArmorMaterial {
    ArmorMaterial SCALE = new ArmorMaterial(29, Util.make(new EnumMap<>(ArmorType.class), map -> {
    ...
    ArmorMaterial TRIBAL = new ArmorMaterial(29, Util.make(new EnumMap<>(ArmorType.class), map -> {
        map.put(ArmorType.BOOTS, 3);
        map.put(ArmorType.LEGGINGS, 6);
        map.put(ArmorType.CHESTPLATE, 8);
    ...
    ArmorMaterial THIEF = new ArmorMaterial(29, Util.make(new EnumMap<>(ArmorType.class), map -> {
    ...
    ArmorMaterial SAGE = new ArmorMaterial(29, Util.make(new EnumMap<>(ArmorType.class), map -> {
        map.put(ArmorType.BOOTS, 2);
        map.put(ArmorType.LEGGINGS, 6);
        map.put(ArmorType.CHESTPLATE, 7);
        map.put(ArmorType.HELMET, 2);
