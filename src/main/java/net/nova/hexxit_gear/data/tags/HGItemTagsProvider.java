...
public class HGItemTagsProvider extends BlockTagCopyingItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        tag(HGTags.ItemTag.REPAIRS_SAGE_ARMOR).add(HGItems.HEXICAL_DIAMOND.get());
        tag(HGTags.ItemTag.REPAIRS_TRIBAL_ARMOR).add(HGItems.HEXICAL_DIAMOND.get());
        tag(HGTags.ItemTag.REPAIRS_THIEF_ARMOR).add(HGItems.HEXICAL_DIAMOND.get());
        tag(HGTags.ItemTag.REPAIRS_SAGE_ARMOR).add(HGItems.HEXICAL_DIAMOND.get());
    }
}
