...
public class HGRecipeProvider extends RecipeProvider {
    ...
    public HGRecipeProvider(PackOutput output) {
        super(output);
        this.output = output;
    }
    ...
    // Recipes
    protected static void oneToOneConversionRecipe(Consumer<FinishedRecipe> pRecipeOutput, ItemLike pResult, ItemLike pIngredient, @Nullable String pGroup) {
        oneToOneConversionRecipe(pRecipeOutput, pResult, pIngredient, pGroup, 1);
    }

    protected static void oneToOneConversionRecipe(Consumer<FinishedRecipe> pRecipeOutput, ItemLike pResult, ItemLike pIngredient, @Nullable String pGroup, int pResultCount) {
